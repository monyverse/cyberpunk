...
const getChainId = (chain) => {
    switch (chain) {
        ...
        case types_1.Chain.Ronin:
            return "2020";
        case types_1.Chain.SaigonTestnet:
            return "2021";
        case types_1.Chain.Abstract:
            return "2741";
        case types_1.Chain.AbstractTestnet:
            return "11124";
...
const isValidProtocol = (protocolAddress) => {
    ...
    const validProtocolAddresses = [constants_1.CROSS_CHAIN_SEAPORT_V1_6_ADDRESS].map((address) => ethers_1.ethers.getAddress(address));
