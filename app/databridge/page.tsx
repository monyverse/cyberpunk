...
import StatsSection from '../../components/databridge/statsSection';
import FileList from '../../components/databridge/fileList';
import Header from '../../components/databridge/header';
import { generateCID, generateCommp } from '../../utils/databridgeDataPrep';
import { ONRAMP_CONTRACT_ABI, ONRAMP_CONTRACT_ADDRESS } from '../../components/databridge/onrampContract';
import React, { useState, useRef, ChangeEvent, DragEvent } from 'react';
import { ethers } from 'ethers';
import { useWaitForTransactionReceipt, useWriteContract } from 'wagmi';
import { uploadToIPFS } from './pinata';
// Lucide icons as named imports
import { Check, File, FileText, Image as ImageIcon, Upload, UploadCloud, X } from 'lucide-react';

const PAYMENT_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_PAYMENT_TOKEN_ADDRESS;

export default function OnRamp(): React.ReactNode {
